...
Welcome to the hardware section of my portfolio. This directory contains the schematics, PCB designs, and firmware source code for my custom embedded systems. (for some of the projects the code might be lost to time)

  

As a Computer Engineer, I focus on building robust hardware architectures that tightly integrate with embedded C firmware. The projects below demonstrate a range of skills, from high-current motor control and real-time kinematics to low-power audio processing and sensor integration.
...
* Full ESD protection on user-facing interfaces.
...
| **MCU Architecture** | STMicroelectronics STM32, clock configuration, hardware timers, ADC/SPI peripherals. |
...
| **Signal Integrity** | Digital galvanic isolation, ESD protection, noise filtering. |

| **Firmware Design** | Real-time kinematics math, USB CDC serial communication. |
